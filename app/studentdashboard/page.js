    ...
    <div className="relative hidden h-screen shadow-lg lg:block w-80">
      <div className="h-full bg-white dark:bg-gray-700">
        <div className="flex items-center justify-start pt-6 ml-8">
          <p className='font-bold text-lg'><span className='text-[#F79256]'>Hamro</span> Subject</p>
        </div>
        <nav className="mt-6">
          <div>
            <a
    ...
    <div className="flex flex-col w-full md:space-y-4">
      ...
      <div className="h-screen px-4 pb-24 overflow-auto md:px-6">
        <h1 className="text-4xl font-semibold text-gray-800 dark:text-white">
          Good afternoom, Student
        </h1>
        <h2 className="text-gray-400 text-md">
          Heres are the open forms of your Subject.
        </h2>
        ...
        <div className="grid grid-cols-1 gap-4 my-4 md:grid-cols-2 lg:grid-cols-3">
          <div className="w-full">
            <div className="relative w-full px-4 py-6 bg-white shadow-lg dark:bg-gray-700">
              ...
              <div>
                <Link href="/form" className="text-xl bg-[#F79256] rounded-lg px-5 py-3 font-bold text-black">
                  Review
                </Link>
              </div>
            </div>
