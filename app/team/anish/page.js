            ...
            <div class="container max-w-lg bg-white rounded dark:bg-gray-800 shadow-lg transform duration-200 easy-in-out m-12">
                ...
                <div class="flex justify-start px-5 -mt-12 mb-5 ">
                    <span clspanss="block relative h-32 w-32">
                        <Image height="500" width="500" alt="Photo by aldi sigun on Unsplash"
                ...
                <div class="">
                    <div class="px-7 mb-8">
                        ...
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 fill-white pr-2" viewBox="0 0 32 32">
                            ...
                            </svg>anishpandey021@gmail.com
                        </div>
                        <div class="flex flex-wrap justify-center gap-2 sm:gap-4 mt-8">
                            <a href="https://x.com/anishraj_pandey?t=s9Tp9Q-LnSnlXozJv67GpQ&s=09" target="blank">
                                <button
                            ...
                            <a href="https://www.facebook.com/anishrajpandey0" target="blank">
                                <button
                                    class="text-green-900 hover:text-green-700 p-1 sm:p-2 inline-flex items-center dark:text-gray-400 dark:hover:text-gray-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7  " viewBox="0 0 50 50"
                                        style={{ "fill": "#014737" }}>
                            ...
                            <a href="https://www.youtube.com/channel/UCen3MzPg5Ob-UojsF9GtFCg" target="blank">
