  ...
  return (
    <div>
        ...
        <div class="container px-6 py-10 mx-auto">
            <h1 class="text-3xl font-semibold text-center text-gray-800 capitalize lg:text-4xl dark:text-white">explore our <br/> awesome <span class="text-blue-700">Features</span></h1>
            ...
            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
                <div class="flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl dark:bg-gray-800">
                    ...
                    <h1 class="text-2xl font-semibold capitalize dark:text-white">Data-Driven</h1>
                ...
                <div class="flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl dark:bg-gray-800">
                    ...
                    <h1 class="text-2xl font-semibold capitalize dark:text-white">Safe & Secure</h1>
                ...
                <div class="flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl dark:bg-gray-800">
                    ...
                    <h1 class="text-2xl font-semibold  capitalize dark:text-white">All in One</h1>
